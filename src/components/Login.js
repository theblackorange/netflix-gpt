...
const Login = () => {
  ...
  return (
    <div>
      ...
      <form onSubmit={(e) => e.preventDefault()} className='w-full p-4 absolute bg-black py-12 my-36 mx-auto right-0 left-0 md:p-4 md:w-3/12 text-white rounded-lg bg-opacity-80'>
